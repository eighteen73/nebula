...
namespace Eighteen73\Nebula\Core\Taxonomies;
...
abstract class AbstractTaxonomy extends Singleton {
	...
	public function get_labels(): array {
		...
		$labels = [
			...
			'popular_items'              => sprintf( __( 'Popular %s', 'nebula-core' ), $plural_label ),
			'all_items'                  => sprintf( __( 'All %s', 'nebula-core' ), $plural_label ),
			'edit_item'                  => sprintf( __( 'Edit %s', 'nebula-core' ), $singular_label ),
			'update_item'                => sprintf( __( 'Update %s', 'nebula-core' ), $singular_label ),
			'add_new_item'               => sprintf( __( 'Add %s', 'nebula-core' ), $singular_label ),
			'new_item_name'              => sprintf( __( 'New %s Name', 'nebula-core' ), $singular_label ),
			'separate_items_with_commas' => sprintf( __( 'Separate %s with commas', 'nebula-core' ), strtolower( $plural_label ) ),
			'add_or_remove_items'        => sprintf( __( 'Add or remove %s', 'nebula-core' ), strtolower( $plural_label ) ),
			'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s', 'nebula-core' ), strtolower( $plural_label ) ),
